...
class DecisionTreeClassifierModel:
    ...
    def generate_usage_instructions(self):
        instructions = (
            ...
            "   with open('decision_tree_classifier_model.pkl', 'rb') as model_file:\n"
        ...
        with open('classifier_model_usage_instructions.txt', 'w') as file:
            file.write(instructions)
        
        print('Instructions for using the saved model have been written to classifier_model_usage_instructions.txt')
...
DecisionTreeClassifierModel(r"C:\Users\MR Wa2el\OneDrive\Desktop\model generator\CHIC\main_models_classes\datasets\size_prediction.csv","size").train()
